...
<title>Candidate Vote Results</title>
                            ...
                            <tbody>
                                <c:forEach var="c" items="${candidates}">
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${not empty c.image}">
                                                    <img src="${pageContext.request.contextPath}/candidates/displaypartyimage/${c.candidateId}"
                                        ...
                                        <td>
                                            <span class="badge bg-success vote-badge">
                                                ${voteCounts[c.candidateId] != null ? voteCounts[c.candidateId] : 0}
                                            </span>
                                        </td>
                                    </tr>
                                </c:forEach>
                        ...
                        <div class="candidate-card">
                            ...
                            <div class="candidate-details">
                                ...
                                <div class="vote-count">
                                    ...
                                    Votes: ${voteCounts[c.candidateId] != null ? voteCounts[c.candidateId] : 0}
                                </div>
                            </div>
                        </div>
                    </c:forEach>
